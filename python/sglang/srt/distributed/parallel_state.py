...
def init_distributed_environment(
    ...
    if not torch.distributed.is_initialized():
        ...
        if backend == "mooncake":
            ...
            # Only the primary WORLD group needs max_world_size pre-provisioning.
            # Joiners already initialize with the full target world_size.
            # Sub-groups are created without max_world_size.
            is_primary = not recovered_rank
