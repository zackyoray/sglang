...
class Scheduler(
    ...
    def handle_scale_elastic_ep(
        ...
        # WORLD has max_world_size headroom; try_recover_ranks() admits new
        # ranks into WORLD only. Sub-groups (TP/attn/moe) are not re-formed —
        # in dp_attention mode collectives that need joiners run over WORLD
        # (see dp_attention._dp_gather_via_all_reduce).
