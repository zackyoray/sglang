...
class ModelRunner(ModelRunnerKVCacheMixin):
    ...
    def initialize(self, pre_model_load_memory: float):
        ...
        skip_graphs = self.server_args.is_ep_joiner
    ...
    def _get_healthy_expert_location_src_rank(
        ...
        # `invoked_in_ep_join_path` is always False here (the True path returned
        # at the top), so each non-joiner rank contributes False.
        world_group = get_world_group()
        gathered_rejoin_flags = world_group.all_gather_object(False)
